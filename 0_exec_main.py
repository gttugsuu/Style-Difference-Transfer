...
output_path = "../output_style_difference/with_everything/"
...
for content_path in content_path_list:
    for style_name in style_name_list:
        ...
        command = 'python main.py -serif_style_path {} -nonserif_style_path {} -content_path {} -output_path {}'.format(style1_path, style2_path, content_path, output_path)
        print(command)
        os.system(command)
